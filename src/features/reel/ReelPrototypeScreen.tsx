...
export function ReelPrototypeScreen() {
  ...
  const [selectedCard, setSelectedCard] = useState<BadgeCard | null>(null);
      ...
      <SafeAreaView edges={["top"]} style={styles.safeArea}>
        <View style={styles.header}>
          <View>
            <Text style={styles.eyebrow}>
              Milestone 2 data-backed prototype
            </Text>
        ...
        <View style={styles.footerPanel}>
          ...
          <Text style={styles.footerText}>
            Swipe vertically to spin the reel. Tap the focused card to preview.
            Double tap any card to favorite. Long press for quick actions.
          </Text>
          <View style={styles.footerStatsRow}>
            <Text style={styles.footerStat}>{favoriteCount} favorites</Text>
            <Text style={styles.footerStat}>
              {isPersisted ? "SQLite backed" : "Mock fallback"}
            </Text>
            {isLoading && (
        ...
        {card && (
          <View style={styles.previewSheet}>
            ...
            <Text style={styles.previewText}>
              This is the Milestone 1 mock detail view. The real viewer will add
              pinch-zoom, front/back switching, and high-contrast reading mode.
            </Text>
